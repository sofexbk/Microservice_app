...
const CreateEventSuper: React.FC = () => {
  ...
  const formik = useFormik({
    ...
    validationSchema: Yup.object({
      ...
      structure: Yup.string().required('La structure est requise'),
    ...
    onSubmit: async (values, { resetForm }) => {
      ...
      if (confirmResult.isConfirmed) {
        ...
        try {
          const response = await axiosInstance.post('/api/evenements/externe', formData, {
            headers: {
      ...
      <Grid container spacing={3}>
        ...
        <Grid item xs={12} md={4}>
          <TextField
            ...
            onChange={formik.handleChange}
            onBlur={formik.handleBlur}
            error={formik.touched.structure && Boolean(formik.errors.structure)}
            helperText={formik.touched.structure && formik.errors.structure}
          />
        </Grid>
        ...
        >
         ...
         <Grid item xs={12} md={4} >
          <TextareaAutosize
            ...
            onChange={formik.handleChange}
            onBlur={formik.handleBlur}
            placeholder="Exemple: 2 Noms et Prénoms (puis sauter ligne), 2 emails (puis sauter ligne) , 2 numéros"
...
export default CreateEventSuper;
