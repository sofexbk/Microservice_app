...
const EventParrainMarrain: React.FC = () => {
  ...
  const fetchUsers = async (page: number, size: number, search: string) => {
    setLoading(true);
    try {
      const response = await axiosInstance.get('/api/role/parrain', {
        params: {
          page: page,
          size: size,
                ...
                <table className="w-full table-auto">
                  <thead>
                    ...
                    Nom {sortField === 'lastName' ? (sortOrder === 'asc' ? '↑' : '↓') : ''}
                      ...
                      >
                    Télephone {sortField === 'telephone' ? (sortOrder === 'asc' ? '↑' : '↓') : ''}
                    </th>
                    <th 
...
export default EventParrainMarrain;
